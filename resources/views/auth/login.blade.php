            ...
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('login.process') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control" placeholder="Email" value="test@user.com">
                    ...
                    @endif
                    <div class="input-group mb-3">
                        <input type="password" name="password" class="form-control" placeholder="Password" value="test@123">
                        <div class="input-group-append">
                            <div class="input-group-text">
